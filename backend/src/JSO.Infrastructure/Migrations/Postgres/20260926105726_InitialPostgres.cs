        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Role = table.Column<string>(type: "text", nullable: false),
                    PositionOrder = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatchOfficials", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MatchId = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: false),
                    HomeValue = table.Column<int>(type: "integer", nullable: true),
                    AwayValue = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Clubs",
                columns: new[] { "Id", "City", "Country", "Description", "LogoUrl", "Name", "ShortName" },
                values: new object[] { new Guid("8d8c1ef6-1c9d-4d1c-9a0f-8a5b6b5c1001"), "Oudhref", "Tunisie", null, null, "Jeunesse Sportive de Oudhref", "JSO" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matches_KickoffAt_Status",
                table: "Matches",
                columns: new[] { "KickoffAt", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MatchOfficials_MatchId",
                table: "MatchOfficials",
                column: "MatchId");

            migrationBuilder.CreateIndex(
                name: "IX_MatchStats_MatchId_Name",
                table: "MatchStats",
